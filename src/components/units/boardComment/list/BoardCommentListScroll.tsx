...
import type { IBoardCommentListScrollProps } from "./BoardCommentListTypes";
...
import BoardCommentWrite from "../write/BoardCommentwriteContainer";

export default function BoardCommentScroll(
  props: IBoardCommentListScrollProps
): JSX.Element {
